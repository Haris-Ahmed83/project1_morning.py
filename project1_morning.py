...
repo_name   = f"project-morning-{today}"
...
code_res = client.models.generate_content(model=MODEL, contents=code_prompt)
...
readme_res = client.models.generate_content(model=MODEL, contents=readme_prompt)
